            ...
            sections={[
                {
                    ...
                    body: (
                        <div className="overflow-x-auto">
                            ...
                            <p className="mt-3">The fee for your order is shown at checkout before you pay. Business days are Monday to Saturday, excluding public holidays.</p>
                        </div>
                    ),
                },
                {
                ...
                },
                {
                    ...
                    body: (
                        <p>Pay on delivery (cash or card on arrival) is available for same-day orders within Nairobi. Please have the exact order total ready; the rider will confirm payment before handing over the parts. Orders that can&apos;t be paid for on arrival are returned to us and may be cancelled.</p>
                    ),
                },
                {
                    id: "receiving",
